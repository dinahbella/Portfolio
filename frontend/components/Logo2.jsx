...
export const InkisionLogo1 = () => (
  <svg
    ...
    className="w-full h-auto max-w-xs sm:max-w-sm md:max-w-[130px] lg:max-w-[200px] text-white dark:text-black"
    style={{
  ...
  >
    <g id="Layer_x0020_1">
      {/* Letters */}
      {["I", "n", "k", "i", "s", "i", "o", "n"].map((char, i) => {
        const xOffsets = [
          -60.44, 120.13, 481.58, 1228.32, 1372.71, 1697.66, 1842.05, 2203.5,
        ];
        return (
          <text
            key={i}
